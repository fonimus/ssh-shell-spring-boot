 ...
 */
 ...
 public class SshShellAutoConfiguration {
     ...
     public ApplicationListener<ContextRefreshedEvent> lazyInitApplicationListener() {
         return event -> {
             String initMessage = "Lazy initialization enabled";
             String initDetails = "Calling configuration beans explicitly to start SSH server and initialize shell correctly";
             LOGGER.info("{}: {}", initMessage, initDetails);
 
             // Explicitly call beans to initialize
