 ...
 */
  ...
  */
 @Slf4j
 public class GrepPostProcessor implements PostProcessor<String, String> {
     ...
     public String process(String result, List<String> parameters) {
         if (parameters == null || parameters.isEmpty()) {
             ...
             for (String line : result.split("\n")) {
                 if (isLineMatching(line, parameters)) {
     ...
     private boolean isLineMatching(String line, List<String> parameters) {
         for (String parameter : parameters) {
             if (isParameterInvalid(parameter) || line.contains(parameter)) {
                 return true;
             }
         }
         return false;
     ...
     private boolean isParameterInvalid(String parameter) {
