...
public abstract class AbstractShellHelperTest {
	...
	public void each() {
		...
		SshContext ctx = new SshContext(new SshShellRunnable(null, null, null, null, null, null, null, null, null, false, null, null, null, null), ter,
				lr, new SshAuthentication(null, null, null, auth));
